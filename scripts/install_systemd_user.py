...
UNIT_NAMES = ("airaware-refresh.service", "airaware-refresh.timer", "airaware-monitoring.service", "airaware-monitoring.timer", "airaware-api.service")
...
def main(argv=None):
    ...
    print("systemctl --user enable --now airaware-monitoring.timer")
